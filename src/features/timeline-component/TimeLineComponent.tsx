...
export const TimeLineComponent: React.FC<TimeLineProps> = (
    ...
    const [currentComponent, setCurrentComponent] = useState(configuration.days[0].events[0].component);
    const [isHoverX, setIsHoverX] = useState(false);

    let array = [configuration.days[0].events[0].component, configuration.days[0].events[1].component]
